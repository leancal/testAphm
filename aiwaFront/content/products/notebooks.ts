...
export const notebooks: Product[] = [
  ...
  { // CA141-C
    ...
    buyLink: `https://www.mercadolibre.com.ar/cloudbook-ca141-c-aiwa-141-4gb-ram-128gb/p/MLA20805041?pdp_filters=category:MLA430687%7Cofficial_store:2739#searchVariation=MLA20805041&position=1&search_layout=grid&type=product&tracking_id=62e339fa-127e-495f-a412-eadfa2465962`,
    featuredFeatures: [
      { id: 61 }, // Windows
  ...
  { // NA-1563A
    name: `Notebook Core i3 8GB RAM Win 11`,
    sku: `NA-1563A`,
    link: `/productos/NA-1563A`,
    categories: [107],
    imgs: [
      `/products/NA-1563A/img/1.webp`,
      `/products/NA-1563A/img/2.webp`,
      `/products/NA-1563A/img/3.webp`,
      `/products/NA-1563A/img/4.webp`,
      `/products/NA-1563A/img/5.webp`,
      `/products/NA-1563A/img/6.webp`,
      `/products/NA-1563A/img/7.webp`,
      `/products/NA-1563A/img/8.webp`,
      `/products/NA-1563A/img/9.webp`,
    ].map((e) => fileserver + e),
    360: false,
    gen: "2º Generación",
    banners: [
      {
        title: `¡Conectate!`,
        img: fileserver + `/banners/puertosna1563A.webp`,
      ...
      },
      {
        ...
        img: fileserver + `/banners/proce1563A.webp`,
        desc: `Posee la potencia suficiente para tus tareas diarias ¡y más! Almacená miles de fotos, videos, audios y documentos.`,
      },
      {
        title: `Más pantalla`,
        img: fileserver + `/banners/pantalla-note1563A.webp`,
        desc: `Su pantalla posee bordes finos para que el contenido que te interesa esté más visible. Alta definición y millones de colores para que tengas una experiencia única.`,
      },
      {
        title: `Cámara web`,
        img: fileserver + `/banners/camaranote1563A.webp`,
        desc: `Podés tener reuniones de trabajo, ver clases online, hacer un meet con tus amigos y familiares, y mucho más.`,
      },
      {
        title: "Potencia de sobra",
        img: fileserver + "/banners/poderna1563A.webp",
    ...
    buyLink: `https://www.mercadolibre.com.ar/notebook-core-i3-aiwa-156-256gb-8gb-ram-win-11-funda-color-gris/p/MLA25571522?pdp_filters=item_id:MLA1392920325`,
    featuredFeatures: [
      { id: 61 }, // Windows
      { id: 62 }, // Camara frontal
      { id: 63, value: "Intel Core i3 1115G4 11th Generación (4.1GHz)" }, // Procesador
      { id: 64, value: "8GB" }, // Memoria RAM
      { id: 65, value: ['15.6"', "1920x1080"] }, // Pantalla
    ...
    features: [
      { id: 41, value: `15.6"` }, // Tamaño de pantalla
      { id: 42, value: `1920*1080` }, // Resolucion
      { id: 43, value: `Intel Core i3 1115G4 11th Generación (4.1GHz)` }, // Procesador
      { id: 44, value: `8GB` }, // Memoria RAM
      { id: 45, value: `256 GigaBytes (SSD)` }, // Almacenamiento
      { id: 46, value: `Frontal (2.0MP)` }, // Cámara
      { id: 36, value: `v5.0` }, // Versión BT
      { id: 48, value: `802.11 ac a/b/g/n` }, // Wifi
      { id: 49, value: `8R/1W*2` }, // Parlante
      { id: 50, value: `Si` }, // Mic
      { id: 52, value: `4 horas` }, // Tiempo de uso
      { id: 8, value: `TF card, USB (3.0x2) y tipo C, Puerto de Red, Auxiliar y HDMI` }, // Entradas
      { id: 47, value: `Windows 11 Home` }, // Sistema operativo
      { id: 16, value: `37.5 cm x 24.3 cm x 2.2 cm` }, // Dimensiones
      { id: 18, value: `1.8Kg` }, // Peso
      { id: 19, value: `7798111354848` }, // EAN
    ],
    includes: [
      24, // Funda
    ...
    certNo: `0Q-AR-01307-T-0`,
    downloads: `https://drive.google.com/drive/folders/1S95wwD31cnfr0EV3koAr8EzJCvHc9vx3?usp=drive_link`,
    colors: [],
  },
  { // NA-1565B
    name: `Notebook Core i5 8GB RAM Win 11`,
    sku: `NA-1565B`,
    link: `/productos/NA-1565B`,
    categories: [107],
    imgs: [
      `/products/NA-1563A/img/1.webp`,
      `/products/NA-1563A/img/2.webp`,
    ...
    banners: [
      ...
      {
        title: `+Potencia, +Memoria`,
        img: fileserver + `/banners/proce1565B.webp`,
        desc: `Posee la potencia suficiente para tus tareas diarias ¡y más! Almacená miles de fotos, videos, audios y documentos.`,
      },
      {
        title: `Más pantalla`,
      ...
      {
        title: "Potencia de sobra",
        img: fileserver + "/banners/poderna1565B.webp",
        desc: "Está equipada con hardware de última generación. Instalá y usá tus programas preferidos sin inconvenientes.",
      },
      {
        title: `Funda de Neoprene`,
    ...
    shortDesc: `Más velocidad, mas potencia`,
    longDesc:
      "Con novedoso hardware que posibilita que tu flujo de trabajo tenga la rapidez y fluidez dignas de un profesional digital.",
    //buyLink: `https://tienda.aiwaelectronics.com.ar/`,
    buyLink: `https://www.mercadolibre.com.ar/notebook-core-i5-aiwa-156-256gb-8gb-ram-win-11-funda-color-gris/p/MLA26998209?pdp_filters=official_store:2739#wid=MLA1392945613&sid=search&searchVariation=MLA26998209&position=22&search_layout=grid&type=product&tracking_id=e7f3e41e-a092-4e1a-a9e4-2a475bd3acda`,
    featuredFeatures: [
      { id: 61 }, // Windows
      { id: 62 }, // Camara frontal
      { id: 63, value: "Intel Core i5 1135G7 11th Generación (4.2GHz)" }, // Procesador
      { id: 64, value: "8GB" }, // Memoria RAM
      { id: 65, value: ['15.6"', "1920x1080"] }, // Pantalla
      { id: 83, value: 'Posee batería de Polímero de Litio 11.4V / 3400mAh con hasta 4 horas de duración' }, // Bateria
      { id: 69, value: "HDMI" }, // Salida monitor
    ...
    features: [
      { id: 41, value: `15.6"` }, // Tamaño de pantalla
      { id: 42, value: `1920*1080` }, // Resolucion
      { id: 43, value: `Intel Core i5 1135G7 11th Generación (4.2GHz)` }, // Procesador
      { id: 44, value: `8GB` }, // Memoria RAM
      { id: 45, value: `256 GigaBytes (SSD)` }, // Almacenamiento
      { id: 46, value: `Frontal (2.0MP)` }, // Cámara
      { id: 36, value: `v5.0` }, // Versión BT
    ...
    certNo: `0Q-AR-01307-T-0`,
    downloads: `https://drive.google.com/drive/folders/1tQAq8Wqz7RZu-UNVzQAzutoC8mHgRkfU`,
    colors: [],
  },
