...
export const tablets: Product[] = [
  { // TA-07-464
    name: `Tablet Aiwa Quad-core 7" 64GB`,
    sku: `TA-07-464`,
    link: `/productos/TA-07-464`,
    categories: [106],
    imgs: [
      `/products/TA-07-464/img/1.webp`,
      `/products/TA-07-464/img/2.webp`,
      `/products/TA-07-464/img/3.webp`,
      `/products/TA-07-464/img/4.webp`,
      `/products/TA-07-464/img/5.webp`,
      `/products/TA-07-464/img/6.webp`,
    ].map((e) => fileserver + e),
    360: false,
    gen: "3º Generación",
    altBackground: true,
    banners: [
      ...
      },
      {
        ...
        img: fileserver + `/banners/TA-07-464/4.webp`,
    ...
    buyLink: `https://www.mercadolibre.com.ar/tablet-aiwa-7-64-gb-4gb-ram-quad-core-android-12-color-gris/p/MLA27070015?pdp_filters=official_store:2739#wid=MLA1510932268&sid=search&searchVariation=MLA27070015&position=23&search_layout=grid&type=product&tracking_id=e7f3e41e-a092-4e1a-a9e4-2a475bd3acda`,
    featuredFeatures: [
      { id: 84 }, // Android 12
      { id: 63, value: "RK3566 Cortex A55 (Quad Core - 1.8GHz)" }, // Procesador
      { id: 64, value: "4GB" }, // Memoria RAM
      { id: 65, value: ['7"', "1024 x 600 px"] }, // Pantalla
      { id: 66 }, // SD
    ...
    features: [
      { id: 43, value: `RK3566 Cortex A55 (Quad Core - 1.8GHz)` }, // Procesador
      { id: 44, value: `4GB` }, // Memoria RAM
      { id: 45, value: `64GB, expandible a 128GB` }, // Almacenamiento
      { id: 47, value: `Android 12` }, // Sistema operativo
      { id: 41, value: `7" 16:9` }, // Tamaño de pantalla
      { id: 42, value: `1024 x 600 px` }, // Resolucion
      ...
      { id: 16, value: `18,9 x 10,9 x 0,88 cm` }, // Dimensiones
      { id: 18, value: `282 g` }, // Peso
      { id: 19, value: `7798111354824` }, // EAN
    ],
    includes: [
      6, // Cable USB tipo C
      9, // Manual y garantía
    ],
    downloads: `https://drive.google.com/drive/folders/1ZROWvPkVaeMhPnaSSKvTUf9KdEMWVMsU`,
  },
  { // TA-10-464
    name: `Tablet Aiwa Quad-core 10" 64GB`,
    sku: `TA-10-464`,
    link: `/productos/TA-10-464`,
    categories: [106],
    imgs: [
      `/products/TA-10-464/img/1.webp`,
      `/products/TA-10-464/img/2.webp`,
      `/products/TA-10-464/img/3.webp`,
      `/products/TA-10-464/img/4.webp`,
    ].map((e) => fileserver + e),
    360: false,
    gen: "3º Generación",
    altBackground: true,
    banners: [
      {
        title: `Ideal para el uso diario`,
        img: fileserver + `/banners/TA-10-464/2.webp`,
        desc: `Navegar en internet, usar redes sociales, ver videos, leer o abrir documentos... Podés hacer esto y mucho más.`,
      },
      {
        title: `Doble cámara`,
        img: fileserver + `/banners/TA-10-464/1.webp`,
        desc: `Hacé videollamadas, tomá fotos o hacé videos sin problema gracias a sus dos cámaras.`,
      },
      {
        title: `Escuchalo todo`,
        img: fileserver + `/banners/TA-10-464/3.webp`,
        desc: `Posee un potente sonido que te permitirá escuchar cada detalle de tu contenido multimedia favorito.`,
      },
      {
        title: `Llevala con vos`,
        img: fileserver + `/banners/TA-10-464/4.webp`,
        desc: `Gracias a su elegante diseño delgado y sólido, además de su poco peso, es ideal para llevarla siempre con vos.`,
      }
    ],
    ...
    buyLink: `https://www.mercadolibre.com.ar/tablet-aiwa-tablet-ta-10-464-101-64gb-color-gris-y-4gb-de-memoria-ram/p/MLA26877257?pdp_filters=official_store:2739#wid=MLA1511641556&sid=search&searchVariation=MLA26877257&position=7&search_layout=grid&type=product&tracking_id=e7f3e41e-a092-4e1a-a9e4-2a475bd3acda`,
    featuredFeatures: [
      { id: 84 }, // Android 12
      { id: 63, value: "RK3566 Cortex A55 (Quad Core - 1.8GHz)" }, // Procesador
      { id: 64, value: "4GB" }, // Memoria RAM
    ...
    //certNo: `RA 4184359 E`,
    downloads: `https://drive.google.com/drive/folders/1hF_ggK7GjYAMYdPcdyjHjreoV3CdtSid`,
  },
