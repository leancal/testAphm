const fileserver = `https://aiwaelectronics.com.ar/photoserver`
...
export const products = [
  ...
  { // AW-T604F
    ...
    banners: [
      {
        title: `¡Pasate a Horizontal!`,
        img: fileserver + `/banners/horizontal604.webp`,
        desc: "Este parlante tiene la posibilidad de utilizarse como barra. Es decir que si tenés espacios reducidos o con otro tipo de disposición, podés siempre encontrar el lugar óptimo para tu parlante.",
      },
      {
        title: `Ideal para fiestas y reuniones`,
        img: fileserver + `/banners/fiestas604.webp`,
        desc: "Posee la potencia y autonomía suficiente para animar cualquier celebración, ¡además podés usarlo conectado y disfrutar por más tiempo!",
      },
      {
        title: `¡Llevalo a todos lados!`,
        img: fileserver + `/banners/portatil604.webp`,
        desc: "Posee batería interna, por lo que podrás escuchar música donde quiera que vayas.",
      },
      {
        title: `Entrada para Micrófono`,
      ...
      {
        title: "True Wireless Stereo",
        img: fileserver + `/banners/tws604.webp`,
        desc: `Conectá dos parlantes iguales y experimentá la combinación de potencia y sonido estéreo real, ¡no querrás volver a usar sólo uno!`,
      },
    ],
  ...
  { // AW-T806F
    ...
    banners: [
      ...
      {
        title: `Elegí como hacer brillar tu fuego`,
        img: fileserver + `/banners/efectos806.webp`,
        desc: `Presionando el botón "Luz" vas a pasar de Llama en llama para elegir la que mejor va con tu fiesta y con tu gente.`,
        priority: true,
      },
      {
        title: `¡Reproducí lo que sea!`,
        img: fileserver + `/banners/panel806.webp`,
        desc: "Posee Radio, puerto USB, entrada Auxiliar y puerto para tarjetas TF/MicroSD.",
      },
      {
        title: "True Wireless Stereo",
        img: fileserver + `/banners/tws806.webp`,
        desc: `Conectá dos parlantes iguales y experimentá la combinación de potencia y sonido estéreo real, ¡no querrás volver a usar sólo uno!`,
      },
    ],
  ...
  { // AW-T1008F
    ...
    banners: [
      {
        title: `¡Reproducí lo que sea!`,
        img: fileserver + `/banners/panel1008.webp`,
        desc: "Posee Radio, puerto USB, entrada Auxiliar y puerto para tarjetas TF/MicroSD.",
      },
      {
        title: `Micrófono Inalámbrico`,
        img: fileserver + `/banners/microfonofx.webp`,
    ...
    longDesc:
      "No solo podrás reproducir música desde cualquier dispositivo, sino que hasta 3 micrófonos pueden conectarse al parlante para poder disfrutar de una noche FLAMA.",
    buyLink: ``,
    featuredFeatures: [
      {
        // Potencia
